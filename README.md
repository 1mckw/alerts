...
GitHub Pages 每小時掃描 **道瓊 30、納指 100、標普 500 指數及成分股** 與 **大宗商品期貨**，日 K 輸出 AR/DR 與趨勢線觸碰報告。
...
**趨勢線：** 至少 3 觸點；上升支撐 + 下降阻力各 1 條（須 `valid_to_current`）；觸碰警報線以細黃線標示；急漲/跌貫穿 grace 2 根 K。
